...
namespace YW.Common
{
    ...
    public static class DirFile
    {
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            System.IO.StreamWriter sw = new System.IO.StreamWriter(CommonHelper.GetMapPath(dir), false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        #endregion
        ...
        {
            dir1 =CommonHelper.GetMapPath(dir1);// dir1.Replace("/", "\\");
            dir2 = CommonHelper.GetMapPath(dir1);//dir2.Replace("/", "\\");
            if (File.Exists(dir1))
                File.Move(dir1, dir2);
        }
        #endregion
        ...
        {
            dir1 = CommonHelper.GetMapPath(dir1);// dir1.Replace("/", "\\");
            dir2 = CommonHelper.GetMapPath(dir2);//dir2.Replace("/", "\\");
            if (File.Exists(dir1))
            {
