<template>
  <div class="upload-box">
    ...
    >
      <template v-if="url">
        <video :src="baseImgUrl(url)" class="upload-image" muted autoplay loop />
...
const props = withDefaults(defineProps<UploadFileProps>(), {
  ...
  disabled: false,
  fileSize: 5,
  fileType: () => ["video/mp4", "video/ogg", "video/flv", "video/avi", "video/wmv", "video/rmvb", "video/mov"],
  height: "150px",
  width: "150px",
  borderRadius: "8px"
});
...
const beforeUpload: UploadProps["beforeUpload"] = rawFile => {
  ...
  if (!imgSize)
    setTimeout(() => {
      ElNotification({
        title: "温馨提示",
        message: `上传大小不能超过 ${props.fileSize}M！`,
        type: "warning"
      });
    }, 0);
