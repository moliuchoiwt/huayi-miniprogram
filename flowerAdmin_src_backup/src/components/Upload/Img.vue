  ...
  <div class="upload-box">
    ...
    >
      <template v-if="imageUrl">
        <img :src="baseImgUrl(imageUrl)" class="upload-image" />
    ...
    <el-image-viewer v-if="imgViewVisible" :url-list="[baseImgUrl(imageUrl)]" @close="imgViewVisible = false" />
  </div>
</template>

<script setup lang="ts" name="UploadImg">
import { ref, computed, inject } from "vue";
import { generateUUID, baseImgUrl } from "@/utils";
